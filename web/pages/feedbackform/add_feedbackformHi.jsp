...
<% ResourceBundle resource = ResourceBundle.getBundle("common");
    String heading      = new String(resource.getString("HeadingHi").getBytes("ISO-8859-1"), "UTF-8");
    String name         = new String(resource.getString("NameHi").getBytes("ISO-8859-1"), "UTF-8");
    String email        = new String(resource.getString("EmailHi").getBytes("ISO-8859-1"), "UTF-8");
    String Question1    = new String(resource.getString("Question1Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question2    = new String(resource.getString("Question2Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question3    = new String(resource.getString("Question3Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question4    = new String(resource.getString("Question4Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question5    = new String(resource.getString("Question5Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question6    = new String(resource.getString("Question6Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question7    = new String(resource.getString("Question7Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question8    = new String(resource.getString("Question8Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question9    = new String(resource.getString("Question9Hi").getBytes("ISO-8859-1"), "UTF-8");
    String Question10    = new String(resource.getString("Question10Hi").getBytes("ISO-8859-1"), "UTF-8");
    String downMessage  = new String(resource.getString("DownMessageHi").getBytes("ISO-8859-1"), "UTF-8");
    String fewWords  = new String(resource.getString("FewWordsHi").getBytes("ISO-8859-1"), "UTF-8");
    String good  = new String(resource.getString("GoodHi").getBytes("ISO-8859-1"), "UTF-8");
    String averege  = new String(resource.getString("AveregeHi").getBytes("ISO-8859-1"), "UTF-8");
    String bad  = new String(resource.getString("BadHi").getBytes("ISO-8859-1"), "UTF-8");
    String few  = new String(resource.getString("FewHi").getBytes("ISO-8859-1"), "UTF-8");
    String many  = new String(resource.getString("ManyHi").getBytes("ISO-8859-1"), "UTF-8");
    String almostAll  = new String(resource.getString("AlmostAllHi").getBytes("ISO-8859-1"), "UTF-8");
    String yes  = new String(resource.getString("YesHi").getBytes("ISO-8859-1"), "UTF-8");
    String no  = new String(resource.getString("NoHi").getBytes("ISO-8859-1"), "UTF-8");
    String willingToGo  = new String(resource.getString("WillingToGoHi").getBytes("ISO-8859-1"), "UTF-8");
    String willingToConnect  = new String(resource.getString("WillingToConnectHi").getBytes("ISO-8859-1"), "UTF-8");
    String pleaseFill  = new String(resource.getString("PleaseFillHi").getBytes("ISO-8859-1"), "UTF-8");
%>
...
<div class="wrapper orange">
    <s:form method="post" action="/AddFeedBackFormHi.do" styleClass="ccform">
        ...
        <div class="ccfield-prepend" style="float:left">
            ...
            <s:text property="email" styleClass="ccformfield" size="50" maxlength="40" onblur="var e = this;validateEmaildisplay('email', e.value, 'Hindi')"/>
        </div>
        <br/>
        <div style="float:left;margin-left:5em"
        ...
        <br>
        <div class="ccfield-prepend" style="float:left">
            <s:submit styleClass="search btn btn-primary btn-lg search" value="Submit"/>
        </div>
        <br>
        <br>
        <div class="ccfield-prepend" style="float:left">
            <s:reset styleClass="search btn btn-primary btn-lg search" value="Reset"/>
        </div>
    </s:form>
</div>
<div class="credit">
